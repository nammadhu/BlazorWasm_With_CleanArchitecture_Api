...
namespace MyTown.Application.Interfaces.Repositories
    ...
    public interface ITownCardRepository : IGenericRepository<TownCard>
        ...
        Task<(List<int> approvedCardIds, List<TownCardDto> draftCards)> GetUserCardsMoreDetails(Guid userId, bool isCreator, bool isOwner, bool isApprovedCardOwner, bool isApprovedReviewer, int townId = 0);
